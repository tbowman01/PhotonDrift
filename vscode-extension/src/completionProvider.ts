...
export class ADRCompletionProvider implements vscode.CompletionItemProvider {
    ...
    private getDecisionCompletions(): vscode.CompletionItem[] {
    ...
    private isInStatusSection(document: vscode.TextDocument, position: vscode.Position): boolean {
